...
namespace Attune.Kernel.Build
{
    ...
    internal sealed class Utility
    {
        ...
        {
            //return GetResource("Attune.Kernel.Build.Resources.TableQuery.sql", "#DatabaseName#", databaseName);
            return "SELECT TABLE_CATALOG, TABLE_SCHEMA,	TABLE_NAME,	TABLE_TYPE FROM INFORMATION_SCHEMA.TABLES WHERE	TABLE_TYPE = 'BASE TABLE'	AND TABLE_NAME != 'dtProperties' AND TABLE_CATALOG = '" + databaseName + "' ORDER BY TABLE_NAME";
        }
        ...
        {
            //  return GetResource("Attune.Kernel.Build.Resources.ColumnQuery.sql", "#TableName#", tableName);
            string strColumnQuery = @"SELECT 
            ...
            strColumnQuery = strColumnQuery.Replace("#TableName#", tableName);
        ...
        /// <param name="column">Object that stores the information for the column the parameter represents.</param>
        /// <returns>String containing parameter information of the specified column for a method call.</returns>
        internal static string CreateMethodParameterwithDefault(Column column)
        {
            string name = column.Name;
            if (column.Name.ToLower().Equals("value"))
                name = "valu";

            return GetCsType(column) + " " + FormatCamel(name) + "=" + Utility.GetDefaultValue(column); ;
        }
        /// <summary>
        /// Creates a string for a method parameter representing the specified column.
        /// </summary>
        /// <param name="column">Object that stores the information for the column the parameter represents.</param>
        /// <returns>String containing parameter information of the specified column for a method call.</returns>
        internal static string CreateMethodParameterwithDefault(string columnName, string columnType)
        {
            string name = columnName;
            //if (columnName.ToLower().Equals("value"))
            //    name = "valu";

            return GetCsType(columnType) + " " + FormatCamel(name) + "=" + Utility.GetDefaultValue(columnType); ;
        }
        ...
        internal static string GetCsType(string columnType)
        {
        ...
        /// <param name="column">The column to get a default value for.</param>
        /// <returns>The default value for the column.</returns>
        internal static string GetDefaultValue(string columnType)
        {
